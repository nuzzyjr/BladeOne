...
<body>
    <div class="header" style="padding: 20px;">
        ...
        <button class="btn btn-secondary" onclick="location = href='add_row.php'">Add record</button>
        <button class="btn btn-secondary" onclick="location = href='edit_table.php'">Edit Table</button>
